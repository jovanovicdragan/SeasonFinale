...
$niz_sport = $connection->nizSport();

echo "<div class=\"row\">
<div class=\"leftcolumn\">";

for ($i = 0; $i < count($niz_sport); $i++) {
    echo "
   
    <div class=\"card\">
        <h1><a href=\"../stranice/vesti.php?id=".$niz_sport[$i][0]."\">".$niz_sport[$i][1]."</a></h1>
      <h5><a href=\"./" . $niz_sport[$i][8] . ".php\">" . $niz_sport[$i][3] . "</a> - - -" . $niz_sport[$i][4] . "</h5>
      <div class=\"img-here\" style=\"height:200px;\"><img style=\"object-fit: cover;\" src='.". $niz_sport[$i][5] . "'; 
      alt=\"spacex\" width=\"100%\" height=\"100%\"></div>
      <p class=\"category-homepage\"><em>" . $niz_sport[$i][7] . "</em></p>";
      $para = explode(".", $niz_sport[$i][10]);
