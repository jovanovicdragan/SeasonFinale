...
$niz_columni = $connection->nizColumni();

echo "<div class=\"row\">
<div class=\"leftcolumn\">";

for ($i = 0; $i < count($niz_columni); $i++) {
    echo "
   
    <div class=\"card\">
        <h1><a href=\"../stranice/vesti.php?id=".$niz_columni[$i][0]."\">".$niz_columni[$i][1]."</a></h1>
      <h5><a href=\"./" . $niz_columni[$i][8] . ".php\">" . $niz_columni[$i][3] . "</a> - - -" . $niz_columni[$i][4] . "</h5>
      <div class=\"img-here\" style=\"height:200px;\"><img style=\"object-fit: cover;\" src='.". $niz_columni[$i][5] . "'; 
      alt=\"spacex\" width=\"100%\" height=\"100%\"></div>
      <p class=\"category-homepage\"><em>" . $niz_columni[$i][7] . "</em></p>";
      $para = explode(".", $niz_columni[$i][10]);
